...
const Details = ({position,company ,companyLink,time,address,work}) => {
    ...
    return <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between md:w-[80%]">
        ...
        >
            ...
            <span className="capitalize font-medium text-dark/75 dark:text-light/75 xs:text-sm font-size">
                {time} | {address}
            </span>
...
/>
  <Details 
    ...
    companyLink="www.google.com"
    time="07/2023 – 08/2023" address="Boulevard Mohammed Derfoufi, Oujda"
    work="
    Creation of a platform for Forest Domain Distraction, Real Estate Exchange, 
    Private Land Acquisition using Bootstrap and PHP."
  />

  <Details 
    position="Intern Oujda" company="ESTO" 
    companyLink="www.google.com"
    time="04/2022 – 07/2022" address="Al Qods University Complex, Oujda"
    work="
    Processing a large medical database in Gulf countries and constructing a 
    dashboard using machine learning, Python, PowerBI, and PowerQuery."
  />

  <Details 
    position="Intern Guercif" company="Commune" 
    companyLink="www.google.com"
    time="04-2021– 06/2021" address="downtown, Guercif"
    work="
    Creation of an intern management application using Java, Swing."
  />

  <Details 
    position="Intern Guercif" company="Commune" 
    companyLink="www.google.com"
    time="08-2020 – 09-2020" address="downtown, Guercif"
    work="
    Creation of an individual life certificate application using C#."
  />
</ul>
