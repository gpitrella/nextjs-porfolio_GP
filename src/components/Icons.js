...
export const FullStackDevelopper = ({ className, ...rest }) => (
  ...
  >
    <svg width="150" height="50">
      <text x="10" y="20" fill="black" font-size="20" font-family="sans-serif">Full Stack Developer</text>
      <text x="10" y="45" fill="black" font-size="20" font-family="sans-serif">Engineer</text>
    </svg>
